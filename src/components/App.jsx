...
function App() {
  ...
  return (
    <div style={{display: 'flex',flexDirection: 'column',alignItems: 'center'}}>
      ...
      <Link to={'/MultiplayerSignupForm'} style={{backgroundColor : "rgb(186, 88, 73)",margin : "20px",padding:"10px 20px 10px 20px",textDecoration: 'none', borderRadius: '20px'}}>Multi Player</Link>
